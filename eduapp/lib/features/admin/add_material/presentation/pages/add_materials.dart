...
import 'package:eduapp/features/admin/edit_material/presentation/edit_material.dart';
import 'package:eduapp/features/admin/new_material/presentation/pages/new_materials.dart';
...
import '../bloc/add_materials_event.dart';
import '../bloc/add_materials_state.dart';
...
class _AddmaterialState extends State<AddMaterial> {
  ...
  void initState() {
    super.initState();
    context
        .read<AddMaterialsBloc>()
        .add(FetchMaterialsByCourseId(course_id: widget.course_id));
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Expanded(
              child: BlocBuilder<AddMaterialsBloc, AddMaterialsState>(
                builder: (context, state) {
                  if (state is AddMaterialsLoading) {
                    return Center(child: CircularProgressIndicator());
                  } else if (state is AddMaterialsLoaded) {
                    _addedmaterials = state.addedMaterials;
                  ...
                  } else if (state is AddMaterialsError) {
                    return Center(
                      child: Text(
                        'Failed to load materials: ${state.message}',
                        style: GoogleFonts.poppins(
                          fontSize: 16,
